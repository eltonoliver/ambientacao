 ...
 * @property System_model $system_model    User Defined model
 * @property Grocery_crud_model $grocery_crud_model    User Defined model
 * @property Site_model $site_model    User Defined model
 * @property Admin_model $admin_model    User Defined model
 */
class CI_Controller{}
